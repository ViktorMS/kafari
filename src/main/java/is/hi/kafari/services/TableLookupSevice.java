...
public class TableLookupSevice {
     ...
     * @param number : Táknar decompression þar sem hvert sæti táknar margfeldi af 5;
     * þannig er 11 = 1*5 mín á 6 metrum, 1*5 mín á 3 metrum. 
     ...
     * @return JSONArray af gildum fyrir rétta töflu. JSONArray inniheldur 
    ...
    private static JSONArray getTable(JSONObject o, int depth){
        ...
        while(true){
            ...
            if(depth<=tableDepth) return o.getJSONObject("tables").getJSONObject(Integer.toString(i)).getJSONArray("table");
